...
class EditProfileForm(forms.ModelForm):
	...
	last_name= forms.CharField(widget=forms.TextInput(attrs={'class': 'form-control'}),max_length=60,required=False)
	...
	profile_info = forms.CharField(widget=forms.TextInput(attrs={'class': 'form-control'}),max_length=400,required=False)
